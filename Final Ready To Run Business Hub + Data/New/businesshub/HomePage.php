...
#sideToastLeft,
#sideToastRight {
  /* Replace with your exact purple or an RGBA */
  background-color: rgba(94, 41, 80, 0.8) !important;
}

/* If you want the little close-button to match, too: */
#sideToastLeft .btn-close-white,
#sideToastRight .btn-close-white {
  filter: invert(85%) sepia(9%) saturate(579%) hue-rotate(245deg) brightness(94%) contrast(88%);
}

:root {
  --header-height: 90px;      /* ضبط ارتفاع الهيدر الفعلي */
  --panel-width: 180px;       /* عرض اللوحة */
  --panel-bg: rgba(94,41,80,0.9); /* اللون الأرجواني الشبه شفاف */
}
...
.side-panel {
  ...
  z-index: 1050;  /* فوق المحتوى ولكن تحت الـ navbar إذا كان z-index أعلى */
  color: #fff;
  display: flex;
  align-items: center;
}
...
/* محتوى اللوحة يظهر بتلاشي بسيط بعد أن تنزلق */
.panel-content {
  opacity: 0;
...
<body>
  ...
  <main class="page-content">
        ...
        <div class="icon-container">
            ...
            <div class="icon-item icon-dropdown">
                ...
                <div class="icon-dropdown-content">
                    ...
                    <a href="departments/MIS.php#courses-table-MIS">نظم المعلومات الإدارية</a>
                    <a href="departments/BUS.php#courses-table-BUS">إدارة الأعمال</a>
                    <a href="departments/ECO.php#courses-table-ECO">اقتصاد الأعمال</a>
                    <a href="departments/PBUS.php#courses-table-PBUS">الإدارة العامة</a>
                    <a href="departments/FNC.php#courses-table-FNC">التمويل</a>
                    <a href="departments/MKT.php#courses-table-MKT">التسويق</a>
                    <a href="departments/ACC.php#courses-table-ACC">المحاسبة</a>
                </div>
            </div>
            <div class="icon-item icon-dropdown">
                <a href="front/halls.php" class="icon-link"><img src="images/ServicesIcon/build.png" alt="Icon 3"></a>
   ...
   القاعات الدراسية
            ...
            <div class="icon-item" id="faq-icon-item" style="position: relative;">
              <a href="#" class="icon-link" id="faq-icon">
                <img src="images/ServicesIcon/FAQ.png" alt="Icon 5">
              </a>
              <div class="info-tooltip" id="faq-tooltip">
...
<!-- 2) Somewhere in your <body>, add two toasts: -->

<div
  class="toast align-items-center text-white bg-success border-0 position-fixed top-50 end-0 me-3"
  id="sideToastRight"
  role="alert"
  aria-live="assertive"
  aria-atomic="true"
  ...
  <div class="d-flex">
    <div class="toast-body">
      <a href="page2.html" class="text-white text-decoration-none">← Visit Page 2</a>
    </div>
    ...
    <div class="slideshow-container">
        <img src="images/busyard2.jpg" alt="Slideshow Image 3">
     ...
     <img src="images/services-nearby-page/food-restaurant5.jpg" alt="Slideshow Image 3">
            <img src="images/busyard3.jpg" alt="Slideshow Image 3">
        <img src="images/services-nearby-page/id1.jpg" alt="Slideshow Image 3">
        <img src="images/services-nearby-page/umawi6.jpg" alt="Slideshow Image 3">
...
<div id="sidePanelLeft" class="side-panel">
  <div class="panel-content">
    <h5>مستخدم جديد؟</h5>
    <p>انشئ حساب لكي تستفيد من خدمات تبادل الكتب وتكون عضو في موقعنا</p>
...
<div class="services-card-container"id="nearbyServices">
 ...
 images/services-nearby-page/res1.jpg
  ">
...
<div class="services-card"
     data-images="images/services-nearby-page/bus-testo.jpg,
                  images/services-nearby-page/tes1.jpg,
                  images/services-nearby-page/tes2.jpg,
                  images/services-nearby-page/bus-testo.jpg">
  <!-- ابدأ بالصورة الأولى -->
  <img src="images/services-nearby-page/tes3.jpg" alt="كشك تيستو الأعمال">
  <p class="services-card-text">
    كشك تيستو - مكتبة صغيرة تخدم طلاب كلية الأعمال
    <span class="services-card-more">
      تحوي قرطاسية، مستلزمات دراسية، خدمات طباعة وتصوير، وأغراض متنوعة يحتاجها الطالب بشكل يومي.
    </span>
  </p>
  <button class="read-more-btn">اقرأ المزيد</button>
</div>
...
<!-- card - كراج التربية -->
<div class="services-card"
     data-images="images/services-nearby-page/garage4.jpg,
                  images/services-nearby-page/garage2.jpg,
                  images/services-nearby-page/garage1.jpg,
                  images/services-nearby-page/garage6.jpg">
  <!-- initial src is your first slide -->
  <img src="images/services-nearby-page/garage4.jpg" alt="كراج التربية">

  <p class="services-card-text">
    كراج التربية
    <span class="services-card-more">
      مواقف لسيارات الطلبة تقي من الحر والظروف الجوية المتنوعة، بمقابل رمزي 1 دينار لعدد طويل من الساعات.
    </span>
  </p>
...
<div class="services-card" data-images="
  ...
  images/services-nearby-page/umawi6.jpg,
  images/services-nearby-page/umawi5.jpg,
  images/services-nearby-page/umawi4.jpg,
  images/services-nearby-page/umawi7.jpg"
  >
...
<!-- card - مركز المخطوطات -->
<div class="services-card" data-images="images/services-nearby-page/history1.jpg,
                                        images/services-nearby-page/mak1.jpg,
                                        images/services-nearby-page/history2.jpg,
                                        images/services-nearby-page/mak2.jpg,
                                        images/services-nearby-page/mak3.jpg">
...
(() => {
  ...
  const tooltip = document.getElementById('faq-tooltip');
  let   timer;
...
<!-- 3) Add this script right before </body> -->
<script>
  // Grab the toast elements and init them
  const toastL = new bootstrap.Toast(document.getElementById('sideToastLeft'));
  const toastR = new bootstrap.Toast(document.getElementById('sideToastRight'));
  let shown = false;

  window.addEventListener('scroll', () => {
    // once you scroll down 300px, show them once
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // When to show / hide (in px)
  const showAt = 900;
  const hideAt = 2100; // panel will hide again once you scroll past this

  window.addEventListener('scroll', () => {
    const y = window.scrollY;

    // if between showAt and hideAt, and not already visible → show
    if (y >= showAt && y < hideAt && !visible) {
      panel.classList.add('visible');
      visible = true;
    }
    // if above hideAt or above/below edges, and currently visible → hide
    else if ((y < showAt || y >= hideAt) && visible) {
