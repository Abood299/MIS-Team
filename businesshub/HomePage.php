        ...
        .burger-menu {
          color: #ffffff93; /* or any color you prefer */
            ...
            .services-card-container {
                ...
                gap: 20px;
                padding: 20px;
                max-width: 1500px; /* controls how wide the card row can grow , كل ما زدت المساحة العرضية بتزيد عدد البوكسات بالسطر الواحد */
                margin: 0 auto;     /* centers the whole grid */
                }
                /* When active, it becomes flex */
                .services-card-container.active {
                display: flex;
                }
                            ...
                            .services-card-container-2 {
                                ...
                                .services-card-container-2.active {
                                display: flex;
                                }
                                .slidePanel2 {
...
<section class="info-section">
    <div class="info-content">
        ...
        <button class="slidePanel1">استكشف</button>
    </div>
...
images/services-nearby-page/lab-law-printing.jpg">
  <img src="images/services-nearby-page/lab-andalus-printing.jpg" alt="Free Printing Labs">
  <p class="services-card-text">
...
">
  ...
  <p class="services-card-text">
    زُر أقرب المصليات الجامعية إليك!<span class="services-card-more"> من مصلى الشريعة، إلى مصليات كلية الحقوق والإنسانية للذكور والإناث، نوفر لك أقرب الأماكن لأداء الصلاة في يومك الجامعي.</span>
  </p>
  <button class="read-more-btn">اقرأ المزيد</button>
</div>
...
<section class="big-slideshow-section"  >
    <div class="big-slideshow-container" class="slidePanel2" style="cursor: pointer;">
    <img src="images/services-nearby-page/slide22.jpg" alt="Slideshow Image 2">
    <img src="images/services-nearby-page/green3.jpg" alt="Slideshow Image 2">
    <img src="images/services-nearby-page/museum3.jpg" alt="Slideshow Image 2">
...
<section style="text-align: center;">
  <div style="display: inline-block; padding-right: 40px;">
    <div class="slidePanel2">
      اصنع ذكريات في هذه الاماكن <span style="font-size: 15px;">اضغـط</span>
    </div>
  </div>
</section>
...
<section>
<!-- Wanna have fun 2 -->
<div class="services-card-container-2">
...
<!-- explore button to show/hide the container 1 -->
<script>
  // Get the button and the card container
  const slidePanelBtn = document.querySelector(".slidePanel1");
  const cardContainer = document.querySelector(".services-card-container");

  // Toggle container visibility on button click
  slidePanelBtn.addEventListener("click", () => {
    cardContainer.classList.toggle("active");

    // Optional: toggle the button text
    if (cardContainer.classList.contains("active")) {
      slidePanelBtn.textContent = "استكشف";
    } else {
      slidePanelBtn.textContent = "استكشف";
    }
  });
...
<!-- explore button to show/hide the container 2 -->
<script>
const slidePanelBtn2 = document.querySelector(".slidePanel2");
const cardContainer2 = document.querySelector(".services-card-container-2");

slidePanelBtn2.addEventListener("click", () => {
