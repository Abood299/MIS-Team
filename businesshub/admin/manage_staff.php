...
// Only allow access if user is logged in and is admin or super_admin
...
<body class="bg-dark text-white p-4">
  <div class="container">
    ...
    <form method="POST" class="bg-secondary p-4 rounded mb-5 text-white">
      ...
      <div class="row g-3">
        <div class="col-md-2"><input name="name" class="form-control" placeholder="Full Name" required></div>
        ...
        <div class="col-md-2"><input name="office_location" class="form-control" placeholder="Office Location"></div>
        <div class="col-md-2">
