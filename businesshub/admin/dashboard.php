...
// Block back-button access after logout
...
<head>
  ...
  <style>
    ...
    .sidebar { width: 250px; min-height: 100vh; background: #1c1c1c; padding-top: 20px; position: fixed; }
    .sidebar h4 { text-align: center; margin-bottom: 30px; }
    .sidebar a { padding: 15px 20px; display: block; font-weight: bold; text-decoration: none; margin-bottom: 5px; }
    .sidebar .bg-books     { background-color: #007bff; color: #fff; }
    .sidebar .bg-courses   { background-color: #28a745; color: #fff; }
    .sidebar .bg-staff     { background-color: #ffc107; color: #000; }
    .sidebar .bg-exchange  { background-color: #dc3545; color: #fff; }
    .sidebar .bg-users     { background-color: #6f42c1; color: #fff; }
    .sidebar a:hover       { filter: brightness(0.9); }
    .topbar { background: #343a40; padding: 10px 20px; margin-left: 250px; display: flex; justify-content: space-between; align-items: center; }
    .main-content { margin-left: 250px; padding: 30px; }
    .dropdown-menu { background: #343a40; border: none; }
    .dropdown-menu a { color: #ffc107; }
    .dropdown-menu a:hover { background: #495057; }
  </style>
...
<body>
  ...
  <div class="topbar">
    <div>
      <a href="dashboard.php" class="text-white text-decoration-none"><strong>Super Admin Dashboard</strong></a>
    </div>
    <div class="d-flex align-items-center gap-3">
      <div class="dropdown">
        <button class="btn btn-dark dropdown-toggle" type="button" id="dropdownUser" data-bs-toggle="dropdown">
