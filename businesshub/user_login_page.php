<?php
// to block blocked users from accessing the login page;
...
<body>
  <div class="split-screen">
    <!-- Left Section: Change the image source below to use your own background image -->
    <div class="left">
...
<div class="right">
  ...
  <script>
    // Basic client-side login form validation
    document.getElementById('loginForm').addEventListener('submit', function(event) {
      ...
      // Process login (e.g., send data to your server via AJAX/fetch)
