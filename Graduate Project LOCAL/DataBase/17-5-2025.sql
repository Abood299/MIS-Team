...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2025 at 09:06 PM
...
(223, 7, '4', 'مهارات الجاهزية لسوق العمل', 'nan');
...
(152, 5, 3, 6, 'هات خنشوف', '2025-05-17 16:04:44', 'dropped');
...
(57, 150, 1, 4, '2025-05-14 16:22:40'),
(58, 151, 1, 7, '2025-05-15 20:41:46'),
(59, 153, 1, 5, '2025-05-15 20:43:40'),
(60, 154, 7, 5, '2025-05-17 11:30:12'),
(61, 156, 1, 5, '2025-05-17 12:52:09');
...
(161, 49, 4, 5, 'q', '2025-05-17 10:26:12', 0, NULL, 0, NULL),
(162, 60, 7, 5, 'مرحبا لين بدي اعطيكي الكتاب وين ممكن نلتقي', '2025-05-17 11:30:33', 0, NULL, 0, NULL);
...
(3, 2, 'Fundamentals of Digital Marketing', 'https://skillshop.exceedlms.com/student/path/29372-fundamentals-of-digital-marketing', 'Discover the new Digital Marketing Fundamentals course – a self-paced program by Google covering 17 expert-designed modules. Learn key topics like AI tools, video marketing, and more through real-world examples and practical exercises to grow your business or career.'),
(4, 7, 'Quality Improvement and Management', 'https://www.coursera.org/learn/quality-improvement-management', 'Learn the importance of quality improvement, explore ISO 9001 benefits and requirements, and translate customer needs into practical actions using Bloom’s Taxonomy.'),
(5, 1, 'C# FOR BEGINNERS', 'https://www.youtube.com/watch?v=GhQdlIFylQ8', 'This course will give you a full introduction into all of the core concepts in C#.'),
(6, 1, 'HTML Front End', 'https://www.mygreatlearning.com/academy/learn-for-free/courses/html-tutorial-for-beginners', 'HTML is the core of web development. Start by learning its basics—features, editors, and comments—then progress to key concepts like the HTML skeleton, elements, and more, building a strong front-end foundation.'),
(7, 4, 'Managerial Accounting', 'https://alison.com/course/management-accounting', 'Learn management accounting to create and manage value, forecast for budgets, explore budgeting theory, control performance, apply linear programming, and handle risk in decisions.'),
(8, 4, 'Cost Accounting', 'https://alison.com/course/diploma-in-cost-accounting', 'Explore financial management and cost accounting basics—cost types, marginal cost functions, budgetary control, and variance formulas—all in a free course to boost your accounting skills.'),
(9, 1, 'JavaScript Crash Course For Beginners', 'https://www.youtube.com/watch?v=hdI2bqOjy3c', 'In this Traversy Media YouTube course, you will learn about JavaScript basics including conditions, loops, functions, objects, arrays, and ES6.'),
(10, 5, 'Managerial Economics', 'https://alison.com/course/diploma-in-managerial-economics', 'Master managerial economics from basics to optimization. Learn consumer behavior, indifference curves, and demand—all in this free online course.'),
(11, 5, 'Macroeconomics', 'https://www.bing.com/videos/search?q=AP+Macroeconomics+Full+Course', ''),
(12, 6, 'Investment Risk Management', 'https://www.coursera.org/learn/investment-risk-management', 'Learn to measure risk vs. reward using the Treynor Ratio and calculate portfolio value at risk. Basic financial risk knowledge is required. Best for North America learners; not investment advice.'),
(13, 7, 'ادارة مشاريع', 'https://www.studyshoot.com/top/free-management-courses/', 'أفضل الشركات العالمية مثل Google وIBM تقدم دورات إدارة مجانية عبر الإنترنت للجميع دون شروط مسبقة، لتعلم مهارات التخطيط والتنظيم والإشراف على المشاريع. في نهاية كل دورة، يحصل المتدربون على شهادات احترافية معتمدة تساعدهم في التوظيف أو بدء مشاريعهم الخاصة.'),
(14, 6, 'اساليب التحليل الكمي', 'https://www.bing.com/videos/search?q=الأساليب+الكمية+في+الإدارة', ''),
(15, 7, 'Marketing Channels Management', 'https://www.coursera.org/learn/channel-management-retailing', 'Learn how to design and manage distribution channels, understand key players and conflict resolution. Explore retail strategies, competitive advantages, growth opportunities, entry methods, and the role of online presence in future retail trends.'),
(16, 2, 'Pricing Policies', 'https://www.coursera.org/learn/pricing-strategy', 'Understand pricing strategies and how psychology affects perceived value. Apply price discrimination through customer traits, quantity, bundling, and versions. Measure willingness to pay using surveys and data. Calculate price elasticity and determine the optimal price.');
...
(389, 4, 5, 138, 'new_message', 'Ahmad sent you a message.', 1, 0, '2025-05-13 20:40:45'),
...
(392, 1, 4, 150, 'request_accepted', 'Abood accepted your request.', 1, 0, '2025-05-14 16:22:40'),
...
(398, 1, 5, 153, 'request_accepted', 'Abood accepted your request.', 1, 0, '2025-05-15 20:43:40'),
(399, 4, 5, 138, 'new_message', 'Ahmad sent you a message.', 1, 0, '2025-05-17 10:26:12'),
(400, 5, 7, 154, 'book_request', 'Leen Ghanem has requested your book', 1, 0, '2025-05-17 11:25:52'),
(401, 7, 5, 154, 'request_accepted', 'Ahmad accepted your request.', 1, 0, '2025-05-17 11:30:12'),
(402, 7, 5, 154, 'new_message', 'Ahmad sent you a message.', 1, 0, '2025-05-17 11:30:33'),
...
(406, 1, 5, 156, 'request_accepted', 'Abood accepted your request.', 1, 0, '2025-05-17 12:52:09'),
...
(409, 3, 5, NULL, 'request_rejected', 'Emad rejected your book request.', 1, 0, '2025-05-17 13:05:15'),
(410, 3, 5, NULL, 'request_rejected', 'Emad rejected your book request.', 1, 0, '2025-05-17 13:05:15'),
...
(414, 3, 1, NULL, 'request_rejected', 'Emad rejected your book request.', 0, 0, '2025-05-17 13:07:02'),
(415, 3, 1, NULL, 'request_rejected', 'Emad rejected your book request.', 0, 0, '2025-05-17 13:07:02');
