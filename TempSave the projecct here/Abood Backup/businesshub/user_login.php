...
form input[type="text"] {
 ...
 <div class="split-screen">
    <div class="left">
      <!-- bottom layer: next slide -->
      <img id="bg-bottom" src="images/sign1.jpg" alt="Background" class="bg-image">
      <!-- top layer: current slide -->
      <img id="bg-top"    src="images/sign1.jpg" alt="Background" class="bg-image">
