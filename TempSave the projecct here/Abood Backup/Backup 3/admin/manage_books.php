...
// by Year
if ($yearFilter !== '') {
    $whereClauses[] = "books.year = " . (int)$yearFilter;
}
...
if (isset($_GET['export']) && $_GET['export'] === 'csv') {
    ...
    // CSV header
    fputcsv($out, ['ID','Book Name','Material','Year','Department']);
    $res = $conn->query("
      SELECT books.id, books.book_name, books.book_material, books.year, departments.department_name
        FROM books
    ...
    <div class="d-flex mb-4 align-items-center no-print">
      ...
      <a
        href="?export=csv
          ...
          <?= $yearFilter? '&year='.urlencode($yearFilter) : '' ?>"
